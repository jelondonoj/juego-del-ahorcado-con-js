...
new Vue({
    ...
    methods: {
        ...
        checkGameStatus() {
            if (this.playerWins()) {
                Swal.fire("¡Haz Ganado! La palabra era " + this.getUnhiddenWord());
                this.resetGame();
            }
            if (this.playerLoses()) {
                Swal.fire("¡Haz Perdido! La palabra era " + this.getUnhiddenWord());
                this.resetGame();
            }
        },
        getUnhiddenWord() {
        ...
        async chooseWord() {
            ...
            if (!words.length) {
                await Swal.fire("-Vamos a agregar algunas palabras antes de empezar-");
